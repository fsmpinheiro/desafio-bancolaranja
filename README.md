Este é um projeto resposta ao [desafio](https://github.com/rafaellins-itau/desafio-itau-vaga-99-junior) proposto pelo user [rafaellins-itau](https://github.com/rafaellins-itau), para pessoas que desejaram se candidatar ao cargo de back-end Júnior. 

Mas a minha real inteção em solucionar este desafio foi conhecer mais sobre testes unitários e como desenvolve-los, além de logss e debug na aplicação.

Tecnologias envolvidas: Spring, Mockito, SLF4J e Swagger.
